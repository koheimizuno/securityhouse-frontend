      ...
      <div className='flex flex-col-reverse gap-4 md:flex-row md:justify-between md:items-center'>
        <div className='flex justify-between md:justify-start items-center gap-6'>
          ...
          <p className='flex items-center gap-3'>
            <Image src='/images/user-icon-sm.svg' alt='user-icon-sm' width={12} height={12} />
        ...
        <div className='flex justify-between items-center'>
          ...
          <div className='flex items-center gap-2'>
            ...
            <a href='#'>
              <Image src='/images/bookmark-icon-gray.svg' alt='bookmark-icon-gray' width={12} height={12} />
            </a>
          </div>
        </div>
      </div>
