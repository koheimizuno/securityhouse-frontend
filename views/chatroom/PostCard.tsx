    ...
    <div className='relative bg-white px-4 py-6 w-[282px] rounded-md'>
      ...
      <div className='grid grid-cols-2 gap-4 mt-[22px] mb-4'>
        <div className='flex items-center gap-2'>
          <Image src='/images/thumbs-up.svg' alt='thumbs-up' width={20} height={20} />
        ...
        <div className='flex items-center gap-2'>
          <Image src='/images/comment-icon.svg' alt='comment w-5 h-5' width={20} height={20} />
          <p className='text-sm font-bold text-colorGray4'>
            <a href='#'>コメント</a>
      ...
      <div className='flex items-center gap-2 mt-4 mb-3'>
        <Image src='/images/user-icon00.svg' alt='user-icon00 w-6 h-6' width={24} height={24} />
        <p className='text-sm'>
