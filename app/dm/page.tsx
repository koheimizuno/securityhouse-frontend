...
const mockMessages = [
  { id: 1, sender: 'Alice', content: 'Hi there!', created_at: '' },
  { id: 2, sender: 'Bob', content: 'Hello! How are you?', created_at: '' },
  { id: 2, sender: 'You', content: 'Hello! How are you?', created_at: '' },
  { id: 3, sender: 'Alice', content: 'I’m good, thanks! What about you?', created_at: '' }
]
