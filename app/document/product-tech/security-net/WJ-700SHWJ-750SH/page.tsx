...
const DocumentWJ700SHWJ750SHPage = () => {
  return (
    <Container className='py-16 flex flex-col gap-16'>
      <PageHeader title='WJ-700SH/WJ-750SH' subtitle='資料集' />
      ...
      <section className='flex flex-col gap-8'>
        ...
        <div className='flex flex-col gap-4'>
          <DocCardButton title='J-810SH PC登録器マニュアルV1029以降（セキュリネット登録編）2020.9.28更新' file='' size='lg' />
...
export default DocumentWJ700SHWJ750SHPage
