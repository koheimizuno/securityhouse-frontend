    ...
    <Container className='py-16 flex flex-col gap-16'>
      ...
      <section className='flex flex-col gap-8'>
        ...
        <div className='flex flex-col gap-4'>
          <DocCardButton title='デジタルレコーダー DVR-M401/M801/M1601 ネットワーク接続手順' size='lg' />
          <DocCardButton title='WJ-700SH「リバース無し」設定時の注意事項' size='lg' />
          <DocCardButton title='映像記録装置の設置場所テクニック' size='lg' />
        </div>
      </section>
      <section className='flex flex-col gap-8'>
        <SectionTitle title='とくとく情報～その2～' bar={true} divider={true} />
        <div className='flex flex-col gap-4'>
          <DocCardButton title='赤外線センサーPXBシリーズ角柱取付の注意事項について' size='lg' />
          <DocCardButton title='AG-808T設置注意事項' size='lg' />
          <DocCardButton title='SAS-2020ラジオ音声混入対策' size='lg' />
        </div>
      </section>
    </Container>
  )
