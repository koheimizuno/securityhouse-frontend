...
const DocumentOtherPage = () => {
  const { session_user_id } = useAuthentication()
  const [otherDocData, setOtherDocData] = useState<DocumentType[] | null>([])

  useEffect(() => {
    getDocumentsAction({ type_id: 1, category_id: 15, user_id: session_user_id }).then(data => setOtherDocData(data))
  }, [session_user_id])
...
export default DocumentOtherPage
