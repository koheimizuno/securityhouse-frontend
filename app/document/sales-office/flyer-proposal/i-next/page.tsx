...
const DocumentProPosalINextPage = () => {
  const { session_user_id } = useAuthentication()
  const [iNextDocData, setINextDocData] = useState<DocumentType[] | null>([])

  useEffect(() => {
    getDocumentsAction({ type_id: 1, category_id: 3, user_id: session_user_id }).then(data => setINextDocData(data))
  }, [session_user_id])
...
export default DocumentProPosalINextPage
