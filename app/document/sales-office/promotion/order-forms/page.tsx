    ...
    <Container className='py-16 flex flex-col gap-20'>
      ...
      <section className='flex flex-col gap-6'>
        ...
        <div className='flex flex-col gap-4'>
          <DocCardButton title='セキュリティハウス販促ツール一覧表（2023年12月7日現在）' size='lg' />
          <DocCardButton title='セキュリティハウス販促ツール　一部価格改定のお知らせ' size='lg' />
        </div>
      </section>
      <section className='flex flex-col gap-6'>
        <SectionTitle title='各種注文書' bar={true} divider={true} />
        <div className='flex flex-col gap-4'>
          <DocCardButton title='SH専用各種カタログお申込書①' size='lg' />
          <DocCardButton title='SH専用各種カタログお申込書②' size='lg' />
        </div>
      </section>
    </Container>
